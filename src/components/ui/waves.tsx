...
export function Waves({
    ...
    const noiseRef = useRef(new Noise(10))
    ...
    return (
        <div
            ...
            className={cn(
                "absolute top-0  bg-gradient-to-br from-blue-600 to-blue-800 left-0 w-full h-full overflow-hidden",
                className,
            )}
        >
            <div
            ...
            />
            <canvas ref={canvasRef} className="block opacity-30 w-full h-full" />
        </div>
    )
}
